    ...
    <div class="container-fluid">
                    ...
                    <div class="card-body">
                        <form method="post">
                            <div class="form-group">
                                ...
                                <br>
                                <input type="number" name="contactInfo" placeholder="Contact Number" class="form-control">
                                <br>
        ...
        <?php 
            if(isset($_POST['register'])){
                $fname = $_POST['fname'];
                $lname = $_POST['lname'];
                $number = $_POST['contactInfo'];
                $location = $_POST['location'];
                $username = $_POST['username'];
                $password = $_POST['password'];

                registerUser($username,$password,$fname,$lname,$number,$location);
            }
